...
- 관리자 쿠폰 발급 통계 API: `api/coupon-issue-statistics.md`
- 관리자 쿠폰 운영 홈 API: `api/coupon-dashboard.md`
...
- Kafka 발급 결과 통계 결정: `adr/004-kafka-coupon-issue-statistics.md`
- Kafka 쿠폰 신청 거절 통계 결정: `adr/005-kafka-coupon-claim-rejection-statistics.md`
