...
class BetSettlementProcessorTest {
    ...
    private final BetSettlementProcessor processor = new BetSettlementProcessor(
            eventRepository,
            userBetRepository,
    ...
    void paysTwiceTheAmountToWinnerAndSettlesLoser() {
        ...
        BetSettlementResult result = processor.settle(1L);
