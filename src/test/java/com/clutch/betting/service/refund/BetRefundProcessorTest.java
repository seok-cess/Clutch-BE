package com.clutch.betting.service.refund;
...
class BetRefundProcessorTest {
    ...
    private final BetRefundProcessor processor = new BetRefundProcessor(
            eventRepository,
            userBetRepository,
    ...
    void refundsOriginalStakeExactlyOnce() {
        ...
        BetRefundResult result = processor.refund(1L);
